...
void bench_group_sucrecoinobi_var(void* arg) {
    int i;
    bench_inv *data = (bench_inv*)arg;
...
#ifndef USE_NUM_NONE
void bench_num_sucrecoinobi(void* arg) {
    int i;
    bench_inv *data = (bench_inv*)arg;
    ...
    for (i = 0; i < 200000; i++) {
        secp256k1_num_sucrecoinobi(&nx, &norder);
    }
}
#endif
...
int main(int argc, char **argv) {
    ...
    if (have_flag(argc, argv, "group") || have_flag(argc, argv, "sucrecoinobi")) run_benchmark("group_sucrecoinobi_var", bench_group_sucrecoinobi_var, bench_setup, NULL, &data, 10, 20000);
...
#ifndef USE_NUM_NONE
    if (have_flag(argc, argv, "num") || have_flag(argc, argv, "sucrecoinobi")) run_benchmark("num_sucrecoinobi", bench_num_sucrecoinobi, bench_setup, NULL, &data, 10, 200000);
#endif
    return 0;
}

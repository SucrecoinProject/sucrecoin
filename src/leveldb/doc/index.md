...
leveldb groups adsucrecoinent keys together into the same block and such a block is
...
Note that the unit of disk transfer and caching is a block. Adsucrecoinent keys

...
/** 
    ...
    ****Note - for XSR we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of sucrecoin coming in to a transaction

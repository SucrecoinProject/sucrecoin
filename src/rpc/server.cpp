...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XSR features */
        {"sucrecoin", "masternode", &masternode, true, true, false},
        {"sucrecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"sucrecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sucrecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sucrecoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"sucrecoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"sucrecoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"sucrecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sucrecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"sucrecoin", "startmasternode", &startmasternode, true, true, false},
        {"sucrecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sucrecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sucrecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sucrecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sucrecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sucrecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sucrecoin", "mnsync", &mnsync, true, true, false},
        {"sucrecoin", "spork", &spork, true, true, false},
        {"sucrecoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2109/\n";
}

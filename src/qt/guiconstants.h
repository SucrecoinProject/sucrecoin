...
/* SucreCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "XSR"
#define QAPP_ORG_DOMAIN "sucrecoin.org"
#define QAPP_APP_NAME_DEFAULT "BitCoin-ONE-Core"
#define QAPP_APP_NAME_TESTNET "BitCoin-ONE-Core-testnet"

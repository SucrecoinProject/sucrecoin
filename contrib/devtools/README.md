...
Setup
---------
Configuring the github-merge tool for the XSR repository is done in the following way:

    git config githubmerge.repository XSR-Project/XSR
...
A script to optimize png files in the XSR

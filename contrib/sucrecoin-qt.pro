...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/sucrecoin-cli.cpp \
           src/sucrecoin-tx.cpp \
           src/sucrecoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/sucrecoin.qrc src/qt/sucrecoin_locale.qrc

TRANSLATIONS += src/qt/locale/sucrecoin_bg.ts \
                src/qt/locale/sucrecoin_de.ts \
                src/qt/locale/sucrecoin_en.ts \
                src/qt/locale/sucrecoin_es.ts \
                src/qt/locale/sucrecoin_fi.ts \
                src/qt/locale/sucrecoin_fr.ts \
                src/qt/locale/sucrecoin_it.ts \
                src/qt/locale/sucrecoin_ja.ts \
                src/qt/locale/sucrecoin_pl.ts \
                src/qt/locale/sucrecoin_pt.ts \
                src/qt/locale/sucrecoin_ru.ts \
                src/qt/locale/sucrecoin_sk.ts \
                src/qt/locale/sucrecoin_sv.ts \
                src/qt/locale/sucrecoin_vi.ts \
                src/qt/locale/sucrecoin_zh_CN.ts \
                src/qt/locale/sucrecoin_zh_TW.ts

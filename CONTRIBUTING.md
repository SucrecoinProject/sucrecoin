...
The following applies to code changes to the SucreCoin Core project, and is not to be
confused with overall XSR Network Protocol consensus changes.
...
Patches that change XSR consensus rules are considerably more involved than
...
Where a patch set proposes to change the XSR consensus, it must have been

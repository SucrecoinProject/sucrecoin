...
ACLOCAL = ${SHELL} /prj/coinFactory/works/bitcoin/sucrecoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /prj/coinFactory/works/bitcoin/sucrecoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /prj/coinFactory/works/bitcoin/sucrecoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /prj/coinFactory/works/bitcoin/sucrecoin/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = sucrecoin-cli
BITCOIN_DAEMON_NAME = sucrecoind
BITCOIN_GUI_NAME = sucrecoin-qt
BITCOIN_TX_NAME = sucrecoin-tx
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /prj/coinFactory/works/bitcoin/sucrecoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = sucrecoin
PACKAGE_BUGREPORT = sucrecoin.io
PACKAGE_NAME = SucreCoin Core
PACKAGE_STRING = SucreCoin Core 2.0.1
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /prj/coinFactory/works/bitcoin/sucrecoin
abs_srcdir = /prj/coinFactory/works/bitcoin/sucrecoin
abs_top_builddir = /prj/coinFactory/works/bitcoin/sucrecoin
abs_top_srcdir = /prj/coinFactory/works/bitcoin/sucrecoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /prj/coinFactory/works/bitcoin/sucrecoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/BitCoin-ONE-Core $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/BitCoin-ONE-Core: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BitCoin-ONE-Core
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BitCoin-ONE-Core: $(OSX_APP_BUILT) $(OSX_PACKAGING)

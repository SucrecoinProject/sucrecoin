...
In order to support loading of multiple wallets in sucrecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sucrecoin.cpp.
...
Changes to sucrecoin.cpp
----------------------
sucrecoin.cpp is the entry point into sucrecoin-qt, and as such, will require some minor modifications to provide hooks for

...
This mechanism has been integrated into Bitcore-Node-XSR which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/XSR-Project/insight-api-sucrecoin#web-socket-api](https://github.com/XSR-Project/insight-api-sucrecoin#web-socket-api) 
* API: [https://github.com/XSR-Project/insight-api-sucrecoin#swifttx-transactions](https://github.com/XSR-Project/insight-api-sucrecoin#swifttx-transactions) 
...
By default, the SucreCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SucreCoin Core daemon:

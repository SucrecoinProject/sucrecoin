...
#   c) node1 mines 32 blocks, so now node 0 has 60001sucrecoin, node 1 has 4250sucrecoin, node2 has none.
#   d) node0 sends 601 sucrecoin to node2, in two transactions (301 sucrecoin, then 300 sucrecoin).
